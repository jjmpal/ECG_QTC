...
args <- list(
  ...
  optparse::make_option("--iteration", type = "integer", default = 1, help = "Iteration [default %default]"),
...
xgb_save(xgb, name = glue::glue("binomial_v5_{ifelse(args$exclude, 'minimum', 'full')}_{args$iteration}"))
